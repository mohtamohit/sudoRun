...
echo "<td><span><a href=writescript.php?name=$curr>New Post</a></span></td>";
?>
<body>
<style>
body{
    ...
    <?php
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        while( $row = mysql_fetch_assoc( $selectRes ) ){
          ...
          <td><a href=deletescript.php?id=$pid&name=$nam>delete</a></td>
          <td><a href=viewscript.php?id=$pid&name=$nam>view</a></td>
          <td><a href=editscript.php?id=$pid&name=$nam>edit</a></td></tr>\n";        
		}
      }
    ?>
  </tbody>

...
$selectSQL = "SELECT * FROM ModPosts";// where writer = '$curr'";
  ...
  <tbody>
    <?php
      ...
      //  	echo $nam;
          ...
          <td><a href=mergescript.php?id=$pid&name=$nam>Merge</a></td>
          <td><a href=modscript.php?id=$pid&name=$nam>View</a></td>
          <td><a href=closescript.php?id=$pid&name=$nam>Close</a></td>\n";
